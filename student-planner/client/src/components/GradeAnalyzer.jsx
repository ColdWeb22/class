    ...
    const analyze = async () => {
        try {
            ...
            const resultData = {
                ...
                achievedGPA: response.data?.achievedGPA || response.achievedGPA,
                gradeCombination: response.data?.gradeCombination || response.gradeCombination,
                isAchievable: response.data?.isAchievable || response.isAchievable
            };
